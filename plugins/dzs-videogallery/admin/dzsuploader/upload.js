...
//            console.log(margs);
            ...
            if(presponse != undefined && presponse.currentTarget!=undefined){
                ...
                if(presponse.currentTarget.responseText!=undefined, presponse.currentTarget.responseText){
                    if(String(presponse.currentTarget.responseText).indexOf('<div class="error">')==0){

                        if (margs._feedback) {
                            margs._feedback.html(String(presponse.currentTarget.responseText));
                            setTimeout(function(){
                                margs._feedback.html('');
                            },1500);
                            console.info('uploader error - '+String(presponse.currentTarget.responseText));
                        }
                        return false;
                    }
                }
...
margs.final_location = final_location;
        ...
        if(window.dzs_upload_realpath){
            ...
            xhr.setRequestHeader("X-File-Upload-Dir", window.dzs_upload_realpath);
        }
