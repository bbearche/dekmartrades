...
function stock_widget_create_row($idx, $stock_data, $sw_settings) {
    ...
    if ($link_url) {
        ...
        $link_wrap_1 = "<a class='stock_watchlist_link' href='https://finance.yahoo.com/q?s={$stock_data['stock_sym']}' target='_blank' rel='external nofollow'>";
	$link_wrap_1 .= "<tooltip><img src=\"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7\" data-src=\"https://finviz.com/chart.ashx?t={$stock_data['stock_sym']}&ty=c&ta=1&p=d&s=m\"></img></tooltip>";
