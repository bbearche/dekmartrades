...
if ( !function_exists('chp_pricing_table_shortcode') ) {
	function chp_pricing_table_shortcode($atts, $content = null) {
...
if ( !function_exists('chp_pricing_column_shortcode') ) {
	function chp_pricing_column_shortcode($atts, $content = null) {
		extract(shortcode_atts(array(
			'title'            => 'Column title',
			'highlight'        => 'false',
			'highlight_reason' => '',
...
if ( !function_exists('chp_pricing_row_shortcode') ) {
	function chp_pricing_row_shortcode($atts, $content = null) {
		extract(shortcode_atts(array(
			'odd' => ''
		), $atts));
...
if ( !function_exists('chp_pricing_column_label_shortcode') ) {
	function chp_pricing_column_label_shortcode($atts, $content = null) {
		extract(shortcode_atts(array(
			'title' => 'Features'
		), $atts));
...
if ( !function_exists('chp_pricing_row_label_shortcode') ) {
	function chp_pricing_row_label_shortcode($atts, $content = null) {
		extract(shortcode_atts(array(
			'odd' => ''
		), $atts));
