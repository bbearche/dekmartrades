...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '21px', 'face' => 'Istok Web', 'style' => 'normal', 'character'  => 'latin', 'color' => '#737885'));
								
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '24px', 'lineheight' => '30px', 'face' => 'Istok Web', 'style' => 'bold', 'character'  => 'latin', 'color' => '#1e2731'));

			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '24px', 'lineheight' => '30px', 'face' => 'Istok Web', 'style' => 'normal', 'character'  => 'latin', 'color' => '#e22004'));
			...
			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '16px', 'lineheight' => '26px', 'face' => 'Istok Web', 'style' => 'normal', 'character'  => 'latin', 'color' => '#e22004'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '24px', 'lineheight' => '21px', 'face' => 'Istok Web', 'style' => 'bold', 'character'  => 'latin', 'color' => '#1e2731'));

			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '16px', 'lineheight' => '21px', 'face' => 'Istok Web', 'style' => 'normal', 'character'  => 'latin', 'color' => '#424f5e'));
			...
			$options['rss_icon'] = array( 
								...
								"desc" => "Rss Icon",
								"id" => "rss_icon",
								"std" => get_stylesheet_directory_uri() . "/images/social/feed.png",
								"type" => "upload");
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '60px', 'lineheight' => '60px', 'face' => 'Istok Web', 'style' => 'bold', 'character'  => 'bold', 'color' => '#1e2731'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '13px', 'lineheight' => '18px', 'face' => 'Istok Web', 'style' => 'normal', 'character'  => 'latin', 'color' => '#252d2c'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '18px', 'lineheight' => '26px', 'face' => 'Istok Web', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
		return $options;
	}
}
?>