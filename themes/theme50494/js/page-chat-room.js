...
$(document).ready(function() {
	...
	$(document).on('click', "#popout_text", function(e) {
	    ...
	    //clear tab html
            //$(getCurrentTab()).html("");
		$(getCurrentTab()).find(".err_msg").hide();
		$(getCurrentTab()).find(".iflychat-embed").show();
		$(getCurrentTab()).find("#chat_popout").show();
	    //reload tab
	...
	function popOutChatCurrent() {
		...
		$(t).find(".err_msg").html(popoutText());
		$(t).find(".iflychat-embed").hide();
		$(t).find("#chat_popout").hide();
