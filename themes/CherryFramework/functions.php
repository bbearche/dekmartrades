...
add_shortcode( 'dekmar_featured', 'dekmar_featured' );
...
function register_follow_table() {
	global $wpdb;
	$wpdb->dt_follow = $wpdb->prefix . 'dt_follow';
}
add_action( 'init', 'register_follow_table' );


// Register Custom Follow Stream
include(WP_CONTENT_DIR . '/follow-stream.php');
add_shortcode( 'follow_stream', 'follow_stream' );
